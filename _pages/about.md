...
2. **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. "On the Perception Bottleneck of VLMs for Chart Understanding." *Arxiv*, 2025. (Code available on GitHub: Vision4Chart)

3. **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. "On the Universal Truthfulness Hyperplane Inside LLMs." *EMNLP 2024*. (Code available on GitHub: Universal_Truthfulness_Hyperplane)
...
A full list of my publications is also available on the [Publications](/publications/) page.
